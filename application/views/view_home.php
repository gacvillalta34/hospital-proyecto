...
<html lang="en">
	...
	<body>
		...
		<div class="jumbotron jumbotron-fluid mb-5">
			...
			<br>
			<br>
				<h1 class="text-primary mb-4">Proyecto - Hospital</h1>
				<h1 class="text-white display-3 mb-5">¡Bienvenido/a!</h1>	
				<br>
				<br>
			</div>
		</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-5 pb-4 pb-lg-0">
						<img class="img-fluid w-100" src="plantilla/images/especialidades_doctor.jpg" alt="">
						<div class="bg-primary text-dark text-center p-4">
							<h3 class="m-0">Experiencia</h3>
						</div>
					</div>
					<div class="col-lg-7">
						...
						<div class="d-flex align-items-center pt-2">
                            ...
                            data-src="https://www.youtube.com/embed/gEPMpJ8eAuo" data-target="#videoModal">
								<span></span>
							</button>
							<h5 class="font-weight-bold m-0 ml-4">Vídeo</h5>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-7 py-5 py-lg-0">
						<h6 class="text-primary text-uppercase font-weight-bold">Contamos con</h6><div class="row">
							<div class="col-sm-4">
								<h1 class="text-primary mb-2" data-toggle="counter-up">100</h1>
								<h6 class="font-weight-bold mb-4">Doctores</h6>
								<img src="plantilla/images/docs.jpg" height="100" width="100"/>
							</div>
							<div class="col-sm-4">
								<h1 class="text-primary mb-2" data-toggle="counter-up">106 </h1>
								<h6 class="font-weight-bold mb-4">Estacionamientos</h6>
								<img src="plantilla/images/parkings.png" height="80" width="90"/>
							</div>
							<div class="col-sm-4">
								<h1 class="text-primary mb-2" data-toggle="counter-up">240</h1>
								<h6 class="font-weight-bold mb-4">Habitaciones</h6>
								<img src="plantilla/images/hospital.png" height="80" width="90"/>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
