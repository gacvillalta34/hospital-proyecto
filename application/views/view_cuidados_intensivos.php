		...
		<br>
					<div align="center">
						<div class="bg-warning text-dark text-center p-6">
							<h3 class="m-0">Cuidados Intensivos</h3>
						</div>
						</div>
			<div align="center">
			<img src="plantilla/images/cuidados_intensivos.jpg" height="300" width="350">
			</div>
		<!-- Header End -->
		<!--  Quote Request Start -->
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-7 py-5 py-lg-0">
						<h6 class="text-primary text-uppercase font-weight-bold">Contamos con</h6>
						<div align="center">
						<div class="row">
							<div class="col-sm-4">
								<h1 class="text-primary mb-2" data-toggle="counter-up">100</h1>
								<h6 class="font-weight-bold mb-4">Pediatras</h6>
								<img src="plantilla/images/docs.jpg" height="150" width="150"/>
							</div>
							<div class="col-sm-4">
								<h1 class="text-primary mb-2" data-toggle="counter-up">240</h1>
								<h6 class="font-weight-bold mb-4">Aréas</h6>
								<img src="plantilla/images/sala_parto.jpg" height="150" width="150"/>
							</div>
						</div>
						</div>
					</div>
